...
class AirportDataManager:
    ...
    def __init__(self, airports_file_path: str, unified_data: Optional[Dict[str, Dict[str, Any]]] = None):
        """
    ...
    def _convert_unified_data(self, unified_data: Dict[str, Dict[str, Any]]) -> Dict[str, Dict[str, Any]]:
